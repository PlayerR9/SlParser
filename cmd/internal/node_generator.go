...
func (n *NodeData) SetPackageName(pkg_name string) {
	if n == nil {
		return
	}
...
var (
	NodeGenerator *generator.CodeGenerator[*NodeData]
)

func init() {
	var err error

	NodeGenerator, err = generator.NewCodeGeneratorFromTemplate[*NodeData]("node", node_templ)
	if err != nil {
		panic(err)
	}
}
