...
// ParsingGen is a generator for the parsing.
type ParsingGen struct {
	// PackageName is the package name.
	PackageName string
}

// SetPackageName implements the generator.PackageNameSetter interface.
func (pg *ParsingGen) SetPackageName(pkg_name string) {
	if pg == nil {
		return
	}

	pg.PackageName = pkg_name
}

// NewParsingGen creates a new ParsingGen.
//
// Returns:
//   - *ParsingGen: The new ParsingGen. Never returns nil.
func NewParsingGen() *ParsingGen {
	return &ParsingGen{}
}

var (
	// ParsingGenerator is the generator for the parsing.
	ParsingGenerator *generator.CodeGenerator[*ParsingGen]
)
...
const parsing_templ string = `// Code generated by SlParser. Do not edit.
package {{ .PackageName }}
